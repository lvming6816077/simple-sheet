...
const ToolBar = (props: any) => {
    ...
    useEffect(() => {
        setCurFS(cellStore.activeCell?.fontSize ? cellStore.activeCell?.fontSize : normalCell.fontSize)
        setCurF(cellStore.activeCell?.fontFamily ? cellStore.activeCell?.fontFamily : normalCell.fontFamily)
    ...
    return (
        ...
        >
            <ReactTooltip effect="solid" place="bottom" className="ReactTooltip"></ReactTooltip>
            ...
            <Menu
                ...
                menuButton={<div className={styles['btn-wrap']} data-tip="字体">
                    <div className={styles['font-family']}>{curF}</div>
                    <div className={styles['triangle']}></div>
                </div>}
            >
                <MenuItem onClick={() => fontFamilyCell('Arial')}>Arial</MenuItem>
                <MenuItem onClick={() => fontFamilyCell('Helvetica')}>Helvetica</MenuItem>
                <MenuItem onClick={() => fontFamilyCell('Calibri')}>Calibri</MenuItem>
                <MenuItem onClick={() => fontFamilyCell('Tahoma')}>Tahoma</MenuItem>
                <MenuItem onClick={() => fontFamilyCell('Times')}>Times</MenuItem>
            </Menu>

            <Menu
                menuClassName="border-menu font-size"
                menuButton={<div className={styles['btn-wrap']} data-tip="字号">
                    <div className={styles['font-family']}>{curFS}</div>
                    <div className={styles['triangle']}></div>
                </div>}
            >
                {
                    [10, 12, 14, 16, 18, 20, 22, 24].map(i => <MenuItem onClick={() => fontSizeCell(i)} key={i}>{i}</MenuItem>)
                }
            </Menu>
            ...
            <Menu
                ...
                menuButton={<div className={styles['btn-wrap']} data-tip="文字颜色">
            ...
            <div className={`${styles['btn-wrap']} ${toolbarStore.currentTextFillBold ? styles['acitve-btn-wrap'] : ''} `}>
                <div className={`${styles['text-bold']}`} onClick={textBoldCell} data-tip="加粗"></div>
            </div>
            <div className={`${styles['btn-wrap']} ${toolbarStore.currentTextFillItalic ? styles['acitve-btn-wrap'] : ''} `}>
                <div className={`${styles['text-italic']}`} onClick={textItalicCell} data-tip="斜体"></div>
            </div>
            <div className={`${styles['btn-wrap']} ${toolbarStore.currentTextFillUnderline ? styles['acitve-btn-wrap'] : ''} `}>
                <div className={`${styles['text-underline']}`} onClick={textUnderLineCell} data-tip="下划线"></div>
            </div>
            <div className={styles['btn-wrap']}>
                <div className={styles['merge-cell']} onClick={mergeCell} data-tip="合并单元格"></div>
            </div>
            <div className={styles['btn-wrap']}>
                <div className={styles['split-cell']} onClick={splitCell} data-tip="拆分单元格"></div>
            </div>
            <Menu
                menuClassName="border-menu"

                menuButton={<div className={styles['btn-wrap']} data-tip="边框">
            ...
            <Menu
                menuClassName="border-menu"
                menuButton={<div className={styles['btn-wrap']} data-tip="边框线条">
            ...
            >
                ...
                <MenuItem onClick={() => borderStyleCell('dashed')}><div className={styles['border-style-item']} style={{ borderBottom: '2px dashed #000' }}></div></MenuItem>
                <MenuItem onClick={() => borderStyleCell('dotted')}><div className={styles['border-style-item']} style={{ borderBottom: '2px dotted #000' }}></div></MenuItem>

            </Menu>
            <Menu
                menuClassName="border-menu no"
                menuButton={<div className={styles['btn-wrap']} data-tip="边框颜色">
            ...
            <Menu
                menuClassName="border-menu no"
                menuButton={<div className={styles['btn-wrap']} data-tip="单元格颜色">
            ...
            <Menu
                menuClassName="border-menu"
                menuButton={<div className={styles['btn-wrap']} data-tip="垂直对齐">
                    {getVAlignBtn()}

                    <div className={styles['triangle']}></div>
                </div>}
            >
                <MenuItem onClick={() => verticalAlignCell('top')}><div className={styles['cell-v-align-top']}></div></MenuItem>
                <MenuItem onClick={() => verticalAlignCell('middle')}><div className={styles['cell-v-align-middle']} ></div></MenuItem>
                <MenuItem onClick={() => verticalAlignCell('bottom')}><div className={styles['cell-v-align-bottom']} ></div></MenuItem>
            ...
            <Menu
                menuClassName="border-menu"
                menuButton={<div className={styles['btn-wrap']} data-tip="水平对齐">
                    {getAlignBtn()}
                    <div className={styles['triangle']}></div>
                </div>}
            >
                <MenuItem onClick={() => alignCell('left')}><div className={styles['cell-align-left']}></div></MenuItem>
                <MenuItem onClick={() => alignCell('center')}><div className={styles['cell-align-center']} ></div></MenuItem>
                <MenuItem onClick={() => alignCell('right')}><div className={styles['cell-align-right']} ></div></MenuItem>
